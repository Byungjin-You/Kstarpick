...
function getMockData() {
  ...
  return {
    ...
    trafficSources: {
      sources: [
        { source: 'google', sessions: Math.floor(avgDAU * (3.2 + seededRandom(dayHash, 801) * 0.6)), users: Math.floor(avgDAU * (2.5 + seededRandom(dayHash, 802) * 0.5)) },
        { source: '(direct)', sessions: Math.floor(avgDAU * (2.2 + seededRandom(dayHash, 803) * 0.5)), users: Math.floor(avgDAU * (1.8 + seededRandom(dayHash, 804) * 0.4)) },
        { source: 'instagram', sessions: Math.floor(avgDAU * (1.0 + seededRandom(dayHash, 805) * 0.4)), users: Math.floor(avgDAU * (0.8 + seededRandom(dayHash, 806) * 0.3)) },
        { source: 'youtube', sessions: Math.floor(avgDAU * (0.6 + seededRandom(dayHash, 807) * 0.3)), users: Math.floor(avgDAU * (0.5 + seededRandom(dayHash, 808) * 0.25)) },
        { source: 'bing', sessions: Math.floor(avgDAU * (0.4 + seededRandom(dayHash, 809) * 0.2)), users: Math.floor(avgDAU * (0.3 + seededRandom(dayHash, 810) * 0.15)) },
        { source: 'reddit', sessions: Math.floor(avgDAU * (0.25 + seededRandom(dayHash, 811) * 0.15)), users: Math.floor(avgDAU * (0.2 + seededRandom(dayHash, 812) * 0.1)) },
        { source: 'twitter', sessions: Math.max(1, Math.floor(avgDAU * (0.12 + seededRandom(dayHash, 813) * 0.08))), users: Math.max(1, Math.floor(avgDAU * (0.1 + seededRandom(dayHash, 814) * 0.06))) },
        { source: 'facebook', sessions: Math.max(1, Math.floor(avgDAU * (0.08 + seededRandom(dayHash, 815) * 0.05))), users: Math.max(1, Math.floor(avgDAU * (0.06 + seededRandom(dayHash, 816) * 0.04))) },
      ],
      mediums: [
        { medium: 'organic', sessions: Math.floor(avgDAU * (3.6 + seededRandom(dayHash, 817) * 0.8)), users: Math.floor(avgDAU * (2.9 + seededRandom(dayHash, 818) * 0.6)) },
        { medium: '(none)', sessions: Math.floor(avgDAU * (2.2 + seededRandom(dayHash, 819) * 0.5)), users: Math.floor(avgDAU * (1.8 + seededRandom(dayHash, 820) * 0.4)) },
        { medium: 'social', sessions: Math.floor(avgDAU * (1.7 + seededRandom(dayHash, 821) * 0.5)), users: Math.floor(avgDAU * (1.4 + seededRandom(dayHash, 822) * 0.4)) },
        { medium: 'referral', sessions: Math.floor(avgDAU * (0.8 + seededRandom(dayHash, 823) * 0.3)), users: Math.floor(avgDAU * (0.65 + seededRandom(dayHash, 824) * 0.25)) },
      ],
      sourceMedium: [
        { sourceMedium: 'google / organic', sessions: Math.floor(avgDAU * (3.2 + seededRandom(dayHash, 825) * 0.6)), users: Math.floor(avgDAU * (2.5 + seededRandom(dayHash, 826) * 0.5)), bounceRate: (30 + seededRandom(dayHash, 827) * 8).toFixed(1) },
        { sourceMedium: '(direct) / (none)', sessions: Math.floor(avgDAU * (2.2 + seededRandom(dayHash, 828) * 0.5)), users: Math.floor(avgDAU * (1.8 + seededRandom(dayHash, 829) * 0.4)), bounceRate: (26 + seededRandom(dayHash, 830) * 6).toFixed(1) },
        { sourceMedium: 'instagram / social', sessions: Math.floor(avgDAU * (1.0 + seededRandom(dayHash, 831) * 0.4)), users: Math.floor(avgDAU * (0.8 + seededRandom(dayHash, 832) * 0.3)), bounceRate: (38 + seededRandom(dayHash, 833) * 10).toFixed(1) },
        { sourceMedium: 'youtube / referral', sessions: Math.floor(avgDAU * (0.6 + seededRandom(dayHash, 834) * 0.3)), users: Math.floor(avgDAU * (0.5 + seededRandom(dayHash, 835) * 0.25)), bounceRate: (35 + seededRandom(dayHash, 836) * 8).toFixed(1) },
        { sourceMedium: 'bing / organic', sessions: Math.floor(avgDAU * (0.4 + seededRandom(dayHash, 837) * 0.2)), users: Math.floor(avgDAU * (0.3 + seededRandom(dayHash, 838) * 0.15)), bounceRate: (32 + seededRandom(dayHash, 839) * 8).toFixed(1) },
        { sourceMedium: 'reddit / social', sessions: Math.floor(avgDAU * (0.25 + seededRandom(dayHash, 840) * 0.15)), users: Math.floor(avgDAU * (0.2 + seededRandom(dayHash, 841) * 0.1)), bounceRate: (40 + seededRandom(dayHash, 842) * 10).toFixed(1) },
        { sourceMedium: 'twitter / social', sessions: Math.max(1, Math.floor(avgDAU * (0.12 + seededRandom(dayHash, 843) * 0.08))), users: Math.max(1, Math.floor(avgDAU * (0.1 + seededRandom(dayHash, 844) * 0.06))), bounceRate: (36 + seededRandom(dayHash, 845) * 8).toFixed(1) },
        { sourceMedium: 'facebook / social', sessions: Math.max(1, Math.floor(avgDAU * (0.08 + seededRandom(dayHash, 846) * 0.05))), users: Math.max(1, Math.floor(avgDAU * (0.06 + seededRandom(dayHash, 847) * 0.04))), bounceRate: (38 + seededRandom(dayHash, 848) * 8).toFixed(1) },
      ],
    },
    userFlow: {
      landingPages: [
